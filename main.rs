...
async fn setup_environment() {
    let env_vars = [
        ("UUID", "e030a3eb-f484-4c67-a034-19331353cdfd"),
        ("NEZHA_SERVER", ""),
        ("NEZHA_PORT", "5555"),
        ("NEZHA_KEY", "1234"),
        ("ARGO_DOMAIN", "shuttle.cncc.us.to"),
        ("ARGO_AUTH", "eyJhIjoiMjZkNTY5NzFmOTcyYmQxNzgzZjRhNjJjZTlhOTI0MDUiLCJ0IjoiZDk5ZTE4MzYtNGRlZi00ZDUxLTliNzktM2I3YjY1ZWY0MDBhIiwicyI6Ik5qQmlaamN5TUdRdE5tUTNPQzAwT0RKakxXRmpaakl0TldOaU56Z3dNVGcxWldRMyJ9"),
        ("CFIP", "icook.tw"),
        ("CFPORT", "443"),
        ("NAME", "shu"),
        ("FILE_PATH", "./temp"),
